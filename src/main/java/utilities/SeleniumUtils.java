...
public class SeleniumUtils {
     ...
     * Note : explicit wait is used to wait for a certain condition to occur before proceeding further in the code
     *                         it's will be coming from ConfigurationReader file that you have to instantiate
     */
